...
jump0:
    ...
    else
    {
        ...
        printf("    Suppose for access your contact, write \"contact\" or \"1\" or key character..\n\n");
        utility();
...
jump:
    ...
    if(strcmp(e,"the")==0||strncmp(e,"bangali",3)==0||strcmp(e,"b")==0||strcmp(e,"l")==0||strncmp(e,"language",3)==0||strcmp(e,"1")==0)
    {
        ...
        printf("\n\nEnter anything to got to country menu: ");
        fflush(stdin);
        gets(e);
        system("cls");
        country();
...
{
    int a,c;
    printf("To check even or odd, enter a number: ");
    scanf("%d",&a);
    if(a%2==0)
    {
        c=1;
...
jump:
    ...
    else if(strcmp(e,"s")==0 ||strncmp(e,"search",3)==0)
    {
        system("cls");
        etc();
    }
...
jump:
    ...
    else if(strcmp(e,"u")==0 ||strncmp(e,"utility",3)==0||strncmp(e,"menu",3)==0)
    {
        system("cls");
        utility();
    }
...
jump0:
    ...
    else if(strncmp(e,"nop",3)==0||strncmp(e,"funny",3)==0||strcmp(e,"f")==0)
    {
        system("cls");
        funny();
    }
...
jump0:
    ...
    else if(strncmp(e,"nop",3)==0||strncmp(e,"utility",3)==0||strcmp(e,"u")==0)
    {
        system("cls");
        utility();
    }
